...
export default () => (
  <DocumentTitle title="About | airlivery">
    <Main className="max-width">
      ...
      <h2>Wer wir sind</h2>
      <p>
        airlivery ist ein junges Unternehmen, das dabei ist, die Logistikwelt zu
        revolutionieren.
      </p>
      <h3>Innovativ</h3>
      <p>
      ...
      <p>
        ...
        iure placeat eveniet sunt et? Adipisci, expedita excepturi. Vero
        praesentium sequi vel facilis obcaecati ut beatae ducimus id voluptates
        placeat?
      </p>
    </Main>
  </DocumentTitle>
